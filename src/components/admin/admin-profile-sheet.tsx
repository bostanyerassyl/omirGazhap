...
export function AdminProfileSheet({ open, onOpenChange }: AdminProfileSheetProps) {
  ...
  const handleAvatarUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setProfile((current) => ({ ...current, avatar: uploadResult.data ?? current.avatar }))
      ...
      <SheetContent side="left" className="w-full sm:max-w-md overflow-y-auto">
        ...
        <div className="mt-4 space-y-6 px-4 pb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="admin-address" className="flex items-center gap-2">
